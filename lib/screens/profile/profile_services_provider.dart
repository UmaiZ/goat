...
class _profile_spState extends State<profile_sp> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: const Text("My Profile",style: TextStyle(color: Colors.white,fontFamily: 'boutrosMedium'),),
          actions: [
            Container(
